 ...
 * @author felipe
 */
public class ServletCadastrarDiaDeProva extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Dentro da ServletCadastrarDiaDeProva  =)");
        boolean status;
        ...
        System.out.println("*******H. Final Prova: "+txtHoraFinalDaProva);
        ...
        status = bo.cadastrarObjetoDiaDeProvaBO(vo);

        if (status == true) {
            System.out.println("Dentro do if true da ServletCadastrarDiaDeProva =)");
            session.setAttribute("statusCadastro", true);
            response.sendRedirect("/PresencaAlunos/cadastros/cadastroDeDiaDeProva.jsp");
            destroy();
        } else {
            System.out.println("Dentro do else (false) da ServletCadastrarDiaDeProva =(");
    ...
    public void destroy() {
        super.destroy();
        log("Destruindo a servlet ServletCadastrarDiaDeProva");
