 ...
 * @author felipe
 */
public class ServletAlteraProfessor extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("ID PROFESSOR : "+txtIdProfessor);
        ...
        status = bo.alterarProfessorBo(vo);

        if (status == true) {
            System.out.println("Dentro do if true da ServletAlteraProfessor =)");
            session.setAttribute("statusAlteracao", true);
            response.sendRedirect("/PresencaAlunos/cadastros/cadastroDeProfessores.jsp");
            destroy();
        } else {
            System.out.println("Dentro do else (false) da ServletAlteraProfessor =(");
    ...
    public void destroy() {
        super.destroy();
        log("Destruindo a servlet ServletAlteraProfessor");
