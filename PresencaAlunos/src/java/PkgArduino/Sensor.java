...
//import gnu.io.rxtx.SerialPorts;
public class Sensor {
     ...
     */
    public Sensor(String portaCOM, int taxa) {
    ...
    private void initialize() {
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Porta transmitida = "+this.portaCOM);
               // System.setProperty("gnu.io.rxtx.SerialPorts", "/dev/ttyACM0");
                portId = CommPortIdentifier.getPortIdentifier(this.portaCOM);
            } catch (NoSuchPortException npe) {
                //Caso a porta COM não exista será exibido um erro 
                JOptionPane.showMessageDialog(null, "Porta COM não encontrada." + npe.toString(),
