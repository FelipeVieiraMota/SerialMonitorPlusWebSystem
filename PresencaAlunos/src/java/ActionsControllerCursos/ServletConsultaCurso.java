 ...
 * @author felipe
 */
public class ServletConsultaCurso extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        String nomeCurso = request.getParameter("selectCurso");
        Gson gson = new Gson();
        CursoBO cursoBO = new CursoBO();
        ArrayList cursoArray;
        cursoArray = cursoBO.pesquisarCursoPeloNome(nomeCurso);
