 ...
 * @author felipe
 */
public class ServletConsultarAlunoEmRelacaoTurma extends HttpServlet {
    ...
    public void destroy() {
        super.destroy();
        log("Destruindo a servlet ServletConsultarAlunoEmRelacaoTurma");
