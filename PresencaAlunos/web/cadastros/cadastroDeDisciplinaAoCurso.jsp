    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <div class="col-sm-3 col-md-3">
                                <form id="formPesquisarDisciplinasJaCadastradasEmAlgumCurso" class="navbar-form" role="search">
                                    <select id="selectDisciplinasJaCadastradasEmAlgumCurso" name="selectDisciplinasJaCadastradasEmAlgumCurso" class="form-control">
                                        <option>Disciplinas já cadastradas nos Cursos</option>
                                    </select>
                                </form>
                            </div>
                ...
                <div class = "container">
                    <h3 class="text-center text-uppercase">Cadastrar Disciplina Em Curso</h3>        
                    <form method="POST" action="" id="formCadastrarDisciplinaCurso"> 
                        <div id="divIdCurso" class="form-group" > 
                            <label id="lbIdCurso">IdCurso</label>
                            <input  type="text"  id="txtIdCurso" name="txtIdCurso"  class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Codigo do Curso</label>
                            <input  type="text"  id="txtCodigoDoCurso" name="txtCodigoDoCurso"  placeholder="Obtem o código do curso desejado.." class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Curso</label>
                            <select id="selectCurso" name="selectCurso" class="form-control">
                                <option>Selecione o Curso Desejado...</option>
                            </select> 
                        </div>
                        <div id="divIdDisciplina" class="form-group" > 
                            <label id="lbID">IdDisciplina</label>
                            <input  type="text"  id="txtIdDisciplina" name="txtIdDisciplina"  class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Codigo da Disciplina</label>
                            <input  type="text"  id="txtCodigoDisciplina" name="txtCodigoDisciplina"  placeholder="Obtem o código da disciplina desejada.." class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                        ...
                        <div class="form-group"> 
                            ...
                            <input  type="text"  id="txtAbreviacaoDisciplina" name="txtAbreviacaoDisciplina" placeholder="Abreviação da disciplina." class="form-control" value="" readonly="true" required="required">
                        </div>  
                        <div class="form-group"> 
                            <label>Carga Horaria Disciplina</label>
                            <input  type="text"  id="txtCargaHorariaDisciplina" name="txtCargaHorariaDisciplina" placeholder="Carga horaria da Disciplina." class="form-control" value="" readonly="true" required="required">
                        </div> 
                        <div class="form-group"> 
                            <label>Disciplina/Curso</label>
                            <input  type="text"  id="txtDisciplinaCurso" name="txtDisciplinaCurso" placeholder="Mesclagem da Disicplina com o Curso" class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
...
<script src="/PresencaAlunos/js/js-DisciplinaCurso/js-disciplinaCurso.js"></script>
<c:choose>   
    <c:when test="${statusCadastro == true}">           
        <script>
                    window.alert("Diciplina cadastrada no Curso com sucesso!");
        </script>  
