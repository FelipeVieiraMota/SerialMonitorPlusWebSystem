<%-- 
    Document   : cadastroDeSemestres
    Created on : Oct 30, 2017, 6:59:42 PM
    Author     : felipe
--%>
...
<html lang="pt-br">
    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <div class="col-sm-3 col-md-3">
                                <form id="formPesquisarSemestres" class="navbar-form" role="search">
                ...
                <div class = "container">
                    <h3 class="text-center text-uppercase">Cadastro de Semestre</h3>        
                    <form method="POST" action="" id="formCadastrarSemestre">
                        <div id="contato"> 
                            <div class="form-group" > 
                                <label id="lbID">ID</label>
                                <input  type="text"  id="txtIdSemestre" name="txtIdSemestre"  class="form-control" value="" required="required">
                            </div>
                            <div class="form-group"> 
                                <label>Codigo do Semestre</label>
                                <input  type="text"  id="txtCodigoDoSemestre" name="txtCodigoDoSemestre" placeholder="Gerado após o cadastro." class="form-control" value="" readonly="true" required="required">
                            </div>

                            <div class="form-group"> 
                                <label>Semestre Vigente</label>
                                <input  type="text"  id="txtSemestre" name="txtSemestre" placeholder="Semestre Atual" class="form-control" value="" required="required">
                            </div>                                                                        
                            <div class="form-group"> 
    ...
    <script src="/PresencaAlunos/js/js-Semestres/js-semestre.js"></script>
    <c:choose>   
        <c:when test="${statusCadastro == true}">           
            <script>
                    window.alert("Semestre cadastrado com sucesso!");
            </script>  
        ...
        <c:when test="${statusAlteracao == false}">           
            <script>
                window.alert("Erro ao salvar os registros! Talvez esse registro não exista. Verifique na se o semestre \n\
              se encontra cadastrado ou entre em contato com o suporte.");
            </script>  
            <c:set var = "statusAlteracao" scope = "session" value = "${null}"/> 
        </c:when>    
    </c:choose>    
