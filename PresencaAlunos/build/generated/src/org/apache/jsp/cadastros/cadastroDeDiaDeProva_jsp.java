...
public final class cadastroDeDiaDeProva_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \n");
      out.write("</body> \n");
      out.write("<script src=\"/PresencaAlunos/js/js-DiaDeProva/js-diasDeProva.js\"></script>\n");
  ...
  private boolean _jspx_meth_c_otherwise_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                <form id=\"formPesquisarDiasDeProva\" class=\"navbar-form\" role=\"search\">\n");
        out.write("                                    <select id=\"selectDiaDeProva\" name=\"selectDiaDeProva\" class=\"form-control\">\n");
        out.write("                                        <option>Selecione o Dia De Prova desejado...</option>\n");
        out.write("                                    </select>\n");
        out.write("                                </form>\n");
        out.write("                            </div>\n");
        ...
        out.write("                    <h3 class=\"text-center text-uppercase\">Cadastro de Dias De Prova</h3>        \n");
        out.write("                    <form method=\"POST\" action=\"\" id=\"formCadastrarDiaDeProva\">\n");
        out.write("                        <div class=\"form-group\" > \n");
        out.write("                            <label id=\"lbIdDiaDeProva\">IdDiaDeProva</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtIdDiaDeProva\" name=\"txtIdDiaDeProva\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\" > \n");
        out.write("                            <label id=\"lbIdTurma\">IdTurma</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtIdTurma\" name=\"txtIdTurma\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\" > \n");
        out.write("                            <label id=\"lbIdDisicplina\">IdDisciplina</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtIdDisicplina\" name=\"txtIdDisicplina\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\" > \n");
        out.write("                            <label id=\"lbIdProfessor\">IdProfessor</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtIdProfessor\" name=\"txtIdProfessor\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\" > \n");
        out.write("                            <label id=\"lbIdSala\">IdSala</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtIdSala\" name=\"txtIdSala\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Codigo Dia De Prova</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtCodigoDaDiaDeProva\" name=\"txtCodigoDaDiaDeProva\" placeholder=\"Gerado após o cadastro.\"  class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Prova</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtProva\" name=\"txtProva\" placeholder=\"Prova.\" class=\"form-control\" value=\"\" readonly=\"true\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Turma</label>\n");
        out.write("                            <select id=\"selectTurma\" name=\"selectTurma\" class=\"form-control\">\n");
        out.write("                                <option>Selecione a Turma desejada...</option>\n");
        out.write("                            </select>\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        ...
        out.write("                            <input  type=\"date\"  id=\"txtData\" name=\"txtData\"  class=\"form-control\" value=\"\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Sala</label>\n");
        out.write("                            <select id=\"selectSala\" name=\"selectSala\" class=\"form-control\">\n");
        out.write("                                <option>Selecione a Sala desejada...</option>\n");
        out.write("                            </select> \n");
        out.write("                        </div> \n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Professor</label>\n");
        out.write("                            <select id=\"selectProfessor\" name=\"selectProfessor\" class=\"form-control\">\n");
        out.write("                                <option>Selecione o Professor desejado...</option>\n");
        out.write("                            </select>\n");
        out.write("                        </div> \n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Dia da Semana</label>\n");
        out.write("                            <select id=\"selectDiaDaSemana\" name=\"selectDiaDaSemana\" class=\"form-control\">\n");
        out.write("                                <option>Selecione o dia desejado...</option>\n");
        out.write("                            </select> \n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Hora Inicial</label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtHoraInicioDaProva\" name=\"txtHoraInicioDaProva\" placeholder=\"Horario Inicial : HH:mm:ss\" class=\"form-control\" value=\"\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Hora Final </label>\n");
        out.write("                            <input  type=\"text\"  id=\"txtHoraFinalDaProva\" name=\"txtHorafinalDaProva\"  placeholder=\"Horario Final : HH:mm:ss\" class=\"form-control\" value=\"\" required=\"required\">\n");
        out.write("                        </div>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <label>Observações</label>\n");
        out.write("                            <textarea  id=\"txtObservacoes\" name=\"txtObservacoes\" placeholder=\"Até 255 caractéres.\" class=\"form-control\" required=\"required\"></textarea>\n");
        out.write("                        </div><br>\n");
        out.write("                        <div class=\"form-group\"> \n");
        out.write("                            <button type=\"submit\" class=\"btn btn-success btn-lg btn-block\" id=\"btnCadastrar\" name=\"btnCadastrar\" value=\"Cadastrar\">Salvar Cadastro</button><br>\n");
        out.write("                            <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block\" id=\"btnAlterar\" name=\"btnAlterar\" value=\"Alterar\">Salvar Ateração</button><br>                             \n");
        out.write("                        </div>\n");
        out.write("                    </form>\n");
        out.write("                </div>                                                         \n");
        out.write("            </div>\n");
  ...
  private boolean _jspx_meth_c_when_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_1, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("           \n");
        out.write("        <script>\n");
        out.write("                    window.alert(\"DiaDeProva cadastrada com sucesso!\");\n");
        out.write("        </script>  \n");
        out.write("        ");
