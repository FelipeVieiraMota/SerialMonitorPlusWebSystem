    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                ...
                <div class = "container">
                    <h3 class="text-center text-uppercase">Cadastro de Turmas</h3>        
                    <form method="POST" action="" id="formCadastrarTurma">
                        ...
                        <div class="form-group" > 
                            <label id="lbIdSemestre">IdSemestre</label>
                            <input  type="text"  id="txtIdSemestre" name="txtIdSemestre"  class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Codigo Turma</label>
                            <input  type="text"  id="txtCodigoDaTurma" name="txtCodigoDaTurma"  placeholder="Gerado após o cadastro." class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Nome da Turma </label>
                            <input  type="text"  id="txtNomeDaTurma" name="txtNomeDaTurma"  placeholder="Nome da Turma" class="form-control" value="" readonly="true" required="required">
                        </div> 
                        <div class="form-group"> 
                            <label>Semestre</label>
                            <select id="selectAnoSemestre" name="selectAnoSemestre" class="form-control">
                                <option>Selecione o Ano/Semestre desejado...</option>
                            </select>
                        </div>
                        <div class="form-group"> 
                            <label>Curso</label>
                        ...
                        <div class="form-group"> 
                            <label>Ciclo</label>
                            <select id="txtCiclo" name="txtCiclo" class="form-control">
                                <option>Selecione o Ciclo desejado...</option>
                            </select>
                        </div> 
                        <div class="form-group"> 
                            <label>Periodo</label>
                            <select id="txtPeriodo" name="txtPeriodo" class="form-control">
                                <option>Selecione o Periodo desejado...</option>
                            </select> 
                        </div> 
                        <div class="form-group"> 
                            <label>Abreviação da Turma</label>
                            <input  type="text"  id="txtAbreviacaoDaTurma" placeholder="Abreviação da turma" name="txtAbreviacaoDaTurma"  class="form-control" value="" required="required">
                        </div>
                        <div class="form-group"> 
...
<script src="/PresencaAlunos/js/js-Turmas/js-turmas.js"></script>
<c:choose>   
