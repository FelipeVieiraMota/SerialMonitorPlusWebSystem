<%-- 
    Document   : cadastroDeCursos
    Created on : Nov 3, 2017, 2:13:08 PM
    Author     : felipe
--%>
    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <div class="col-sm-3 col-md-3">
                                <form id="formPesquisarCursos" class="navbar-form" role="search">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">                                        
                                        ...
                                        <li><a id="aTagVincularUmaDisciplinaAoCurso" href="#">Vincular Curso com Disciplina</a></li>
                ...
                <div class = "container">
                    <h3 class="text-center text-uppercase">Cadastro de Cursos</h3>        
                    <form method="POST" action="" id="formCadastrarCurso">
                        <div class="form-group" > 
                            <label id="lbID">ID</label>
                            <input  type="text"  id="txtIdCurso" name="txtIdCurso"  class="form-control" value="" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Codigo do Curso</label>
                            <input  type="text"  id="txtCodigoCurso" name="txtCodigoCurso" placeholder="Gerado após o cadastro" class="form-control" value="" readonly="true" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Nome do Curso</label>
                            <input  type="text"  id="txtNomeDoCurso" name="txtNomeDoCurso"  placeholder="Nome do Curso" class="form-control" value="" required="required">
                        </div> 
                        <div class="form-group"> 
                            <label>Tipo de Curso</label>
                            <input  type="text"  id="txtTipoDeCurso" name="txtTipoDeCurso"  placeholder="Tipo de Curso" class="form-control" value="" required="required">
                        </div> 
                        <div class="form-group"> 
                            <label>Duracão</label>
                            <input  type="text"  id="txtDuracaoDoCurso" name="txtDuracaoDoCurso"  placeholder="Duração do Curso em anos" class="form-control" value="" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Qtd.Semestres</label>
                            <input  type="text"  id="txtQtdSemestres" name="txtQtdSemestres"  placeholder="Quantidade de Semestres" class="form-control" value="" required="required">
                        </div>
                        <div class="form-group"> 
                            <label>Carga Horaria</label>
                            <input  type="text"  id="txtCargaHoraria" name="txtCargaHoraria"  placeholder="Total de horas do curso." class="form-control" value="" required="required">
                        </div>
                        <div class="form-group"> 
...
<script src="/PresencaAlunos/js/js-Cursos/js-cursos.js"></script>
<c:choose>   
