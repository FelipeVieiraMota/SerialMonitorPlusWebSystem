    ...
    <body>
        <c:choose>
            ...
            <c:otherwise>
                ...
                <div class = "container">
                    <h3 class="text-center text-uppercase">Pesquisar Frequência dos Alunos</h3> <br><br>       
...
<script src="/PresencaAlunos/js/js-FrequenciaDeAlunos/js-frequenciaDeAlunos.js"></script>
<c:choose>   
